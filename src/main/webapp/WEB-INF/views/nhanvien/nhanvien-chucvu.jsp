...
<head>
    ...
    <title>Thông tin vị trí tuyển dụng</title>
    ...
    <div class="row flex-nowrap">
		...
		<div class="col py-3">
           ...
           <div>
			...
			<tbody>
				<c:forEach var="vt" items="${ctChucVu}">
					<tr>
						<td>${vt.getIdCTChucVu()}</td>
						<td>${vt.getChucVu().getTen() }</td>
						<td>${vt.getLoaiNhanVien()}</td>
						<td>${vt.getLuong() }</td>
						 <td>
						<a href="nhanvien-suachucvu/${vt.getIdCTChucVu() }.htm?"> 
