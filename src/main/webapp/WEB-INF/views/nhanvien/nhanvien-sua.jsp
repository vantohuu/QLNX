		...
		<div class="col py-3">
		  ...
		  <form:form action="update.htm" modelAttribute="nhanVien">
		    ...
		    <div class="col-sm-4">
		        ...
		        <form:input path="ho" type="text" class="form-control" readonly="true" />
		     </div>
		     <div class="col-sm-4">
		        <label for="name" class="form-label">Tên:</label>
		        <form:input path="ten" type="text" class="form-control" readonly="true" />
		     </div>
		    </div>
		    <div class="form-group row">
		    <div class="col-sm-2">
		        <label for="name" class="form-label">Giới tính:</label>
		        <form:input path="gioiTinh" type="text" class="form-control" readonly="true" />
		     </div>
		     <div class="col-sm-3">
		        <label for="name" class="form-label">SĐT:</label>
		        <form:input path="sdt" type="text" class="form-control" readonly="true" />
		     </div>
		     <div class="col-sm-4">
		    ...
		    <div class="col-sm-2">
		        ...
		        <form:input path="ngaySinh" type="text" class="form-control" readonly="true" />
		     </div>
		     <div class="col-sm-4">
		        <label for="name" class="form-label">Địa chỉ:</label>
		        <form:input path="diaChi" type="text" class="form-control" readonly="true" />
		     </div>
		    </div>
		     <div class="form-group row">
		     <div class="form-group col-sm-4" style="margin-top: 20px;">
		    	<label for="chucVu">Chức vụ:</label>
		     <form:select path="CTChucVu.chucVu.maCV" items="${chucVu }"
						itemValue="maCV" itemLabel="ten">

					</form:select></div>	

		    <div class="form-group col-sm-4" style="margin-top: 20px;">
		    	<label for="chucVu">Hình thức:</label>
		     <form:select path="CTChucVu.loaiNhanVien" items="${loaiNhanVien}">
